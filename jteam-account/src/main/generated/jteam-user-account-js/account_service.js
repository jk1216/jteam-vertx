...
/** @module jteam-user-account-js/account_service */
var utils = require('vertx-js/util/utils');

var io = Packages.io;
var JsonObject = io.vertx.core.json.JsonObject;
var JAccountService = Java.type('com.jteam.vertx.account.AccountService');
...
var AccountService = function(j_val) {
  ...
  this.addAccount = function(account, resultHandler) {
    ...
    if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
      j_accountService["addAccount(com.jteam.vertx.account.Account,io.vertx.core.Handler)"](account != null ? new Account(new JsonObject(Java.asJSONCompatible(account))) : null, function(ar) {
      if (ar.succeeded()) {
        resultHandler(null, null);
      } else {
        resultHandler(null, ar.cause());
  ...
  this.updateAccount = function(account, resultHandler) {
    var __args = arguments;
    if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
      j_accountService["updateAccount(com.jteam.vertx.account.Account,io.vertx.core.Handler)"](account != null ? new Account(new JsonObject(Java.asJSONCompatible(account))) : null, function(ar) {
      if (ar.succeeded()) {
        resultHandler(utils.convReturnDataObject(ar.result()), null);
      } else {
        resultHandler(null, ar.cause());
...
AccountService._jclass = utils.getJavaClass("com.jteam.vertx.account.AccountService");
