...
package com.jteam.vertx.account.rxjava;
 ...
 *
 * <p/>
 * NOTE: This class has been automatically generated from the {@link com.jteam.vertx.account.AccountService original} non RX-ified interface using Vert.x codegen.
 */

@io.vertx.lang.rxjava.RxGen(com.jteam.vertx.account.AccountService.class)
public class AccountService {

  public static final io.vertx.lang.rxjava.TypeArg<AccountService> __TYPE_ARG = new io.vertx.lang.rxjava.TypeArg<>(
    obj -> new AccountService((com.jteam.vertx.account.AccountService) obj),
    AccountService::getDelegate
  );

  private final com.jteam.vertx.account.AccountService delegate;
  
  public AccountService(com.jteam.vertx.account.AccountService delegate) {
    this.delegate = delegate;
  }

  public com.jteam.vertx.account.AccountService getDelegate() {
    return delegate;
  }
  ...
  public static AccountService newInstance(com.jteam.vertx.account.AccountService arg) {
